...
export const PERMISSIONS = {
  ...
  SALES_ORDER_OVERRIDE_PRICE: 'sales.order.override_price',
  SALES_SERVICE_READ: 'sales.service.read',
  SALES_SERVICE_WRITE: 'sales.service.write',
  // production
...
export const PERMISSION_DESCRIPTIONS: Record<Permission, string> = {
  ...
  'sales.order.override_price': 'Override an auto-calculated order line price, with a reason',
  'sales.service.read': 'View the services catalogue (pricing)',
  'sales.service.write': 'Create and edit services and their pricing',
